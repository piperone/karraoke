export default [
    ...
    },
    {
        ...
        album: 'SOUR',
        year: 2021,
        art: 'olivia-rodrigo-good-4-u.jpg',
        lyrics: `
            <p>
                <i>Intro</i><br>
                (Ah)
            ...
            <p>
                ...
                Good for you<br>
                You're doin' great out there without me, baby<br>
                God, I wish that I could do that<br>
                I've lost my mind, I've spent the night<br>
                Cryin' on the floor of my bathroom<br>
            ...
            <p>
                ...
                Baby, what the fuck is up with that? (Ah)<br>
                And good for you, it's like you never even met me<br>
                Remember when you swore to God I was the only<br>
                Person who ever got you? Well, screw that, and screw you<br>
    ...
    {
        id: 3,
        title: 'Den fineste Chevy\'n',
        artist: 'Halva Priset &amp; Maria Mena',
        album: 'Den fineste Chevy\'n - Single',
        year: 2021,
        art: 'halva-priset-den-fineste-chevyn.jpg',
        lyrics: `
        <p>
            <i>Vers 1</i><br>
            Hun ba han å te seg, for i kveld var de med fintfolk<br>
            Snakk om vær og vind for det har substans<br>
            Han var en jævel te å skru bil, det hadd'n styr på<br>
            Men han hører ikke forskjell på gresk og finans<br>
            Han kommer fra et helt annet miljø<br>
            Det er oljesøl og raggen måste gå<br>
            Hun er fra en finere familie<br>
            At han er rægger, kan de aldri få vite om
        </p>

        <p>
            <i>Refreng</i><br>
            Han har den fineste Chevy'n i hele dalen<br>
            Nå sitter'n drita full i eget flak<br>
            Skulle aldri kjørt, skulle hatt sjåfør<br>
            Så på bunn av denne sjøen<br>
            Ligger den fineste Chevy'n i hele dalen
        </p>

        <p>
            <i>Vers 2</i><br>
            Han er god som gull men aldri hatt ei krone<br>
            Han er fornøyd om han har penger til bensin<br>
            Jeg har fortalt til nær og kjær at han går på skole<br>
        ...
        <p>
            ...
            Han har den fineste Chevy'n i hele dalen<br>
            Nå sitter'n drita full i eget flak<br>
            Skulle aldri kjørt, burde hatt sjåfør<br>
            Så på bunn av denne sjøen<br>
            Ligger den fineste Chevy'n i hele dalen
        </p>
        ...
        <p>
            <i>Bro</i><br>
            Jeg snur jorda på hue for at du skal ha det bra<br>
            Men jeg e'kke en sånn fyr som de vil du skal ha<br>
            I kveld skal vi spise med Michelin-kokk<br>
            Og jeg går kledd som en finanssnobb<br>
        ...
        <p>
            ...
            Skulle aldri kjørt, burde hatt sjåfør<br>
            Så på bunn av denne sjøen<br>
            Ligger den fineste Chevy'n i hele dalen<br>
            Ligger den fineste Chevy'n i hele dalen<br>
            Ligger den fineste Chevy'n i hele dalen
        </p>
        `,
    ...
    {
        id: 4,
        title: 'Smilet i ditt eget speil',
        artist: 'Chris Holsten',
        album: 'Bak en fasade',
        year: 2021,
        art: 'chris-holsten-smilet-i-ditt-eget-speil.jpg',
        lyrics: `
        <p>
            <i>Intro</i><br>
            (På roser)<br>
        ...
        <p>
            <i>Vers 1</i><br>
            Jeg ser du kunne hatt det litt bedre<br>
            Jeg vet du har det vondt<br>
            Du slipper ingen inn på deg<br>
            Små føtter i et iskaldt hav<br>
            Med hodet under vann<br>
        ...
        <p>
            ...
            Det var smilet i ditt eget speil<br>
            Stupe i havet<br>
        ...
        <p>
            <i>Vers 2</i><br>
            Kast maska, du har lov til å gråte<br>
            Du skulle ha sagt ifra<br>
            Men vet at det er lett å si<br>
            Ikke hør på alle stemmer i hodet<br>
            Som sier du er svak<br>
        ...
        <p>
            <i>Outro</i><br>
            De sa jeg dansa på roser<br>
            De sa jeg aldri trår feil<br>
            Men det var en ting jeg savna<br>
    ...
    },
    {
        ...
        album: 'I',
        year: 2003,
        art: 'kurt-nilsen-shes-so-high.jpg',
        lyrics: `
        <p>
            <i>Vers 1</i><br>
            She's blood, flesh, and bone<br>
            No tucks or silicone<br>
            She's touch, smell, sight, taste and sound<br>
            But somehow I can't believe that anything should happen<br>
        ...
        <p>
            <i>Vers 2</i><br>
            First class and fancy free, she's high society<br>
            She's got the best of everything<br>
            What could a guy like me ever really offer?<br>
            She's perfect as she can be<br>
        ...
        <p>
            <i>Vers 3</i><br>
            She comes to speak to me<br>
            I freeze immediately<br>
            'Cause what she says sounds so unreal<br>
            'Cause somehow I can't believe that anything should happen<br>
            I know where I belong and nothing's gonna happen
        </p>
    ...
    },
    {
        ...
        artist: 'The Kids',
        album: 'The Kids: Greatest Hits',
        year: 1980,
        art: 'the-kids-forelska-i-larern.jpg',
        lyrics: `
        <p>
            <i>Vers 1</i><br>
            Hun sitter foran meg på første rad<br>
            Hun har blå øyne er bestandig glad<br>
            ...
            Hun er forelska men<br>
            Det er ikke i meg
        </p>

        <p>
            <i>Refreng</i><br>
            Hun er forelska i lærer'n (åh-åh-åh)<br>
            Forelska i lærer'n (åh-åh-åh)<br>
            Hun er forelska i lærer'n<br>
            Og ikke i meg
        </p>

        <p>
            <i>Vers 2</i><br>
            Lærer'n vår er tjue år<br>
            Han har kraftig kropp og halvlangt hår<br>
            Han er hele skolens Don Juan<br>
            Og jeg er bare femten år<br>
            Hun sier "Kom tilbake om fire år"<br>
            Hun er forelska men<br>
            Det er ikke i meg
        </p>
    ...
    },
    {
        ...
        album: 'Den du veit',
        year: 1981,
        art: 'marius-muller-den-du-veit.jpg',
        lyrics: `
        <p>
            <i>Vers 1</i><br>
            Jeg hører telefonen ringe<br>
            Snubler i teppet når jeg løper for å ta'n<br>
            Og når jeg løfter av røret<br>
            Og hører stemmen din se veit jeg hva det er
        </p>
        ...
        <p>
            ...
            Du trenger bare knipse og si hei<br>
            Jeg kommer alltid løpende til deg
        </p>

        <p>
            <i>Vers 2</i><br>
            Du spør om jeg har no'e gjøre<br>
    ...
    },
    {
        ...
        year: 1986,
        art: 'bon-jovi-livin-on-a-prayer.jpg',
        lyrics: `
        <p>
            <i>Intro</i><br>
        ...
        <p>
            ...
            Workin' for her man, she brings home her pay<br>
            For love<br>
            Mm, for love
        </p>
        ...
        <p>
            <i>Refreng</i><br>
            Woah, we're halfway there<br>
            Woah-oh, livin' on a prayer<br>
        ...
        <p>
            ...
            Now he's holdin' in, when he used to make it talk<br>
            So tough<br>
            Ooh, it's tough<br>
            Gina dreams of runnin' away<br>
            When she cries in the night, Tommy whispers<br>
            "Baby, it's okay<br>
            Someday"
        </p>
        ...
        <p>
            <i>Bro</i><br>
            Ooh, we gotta hold on, ready or not<br>
    ...
    },
    {
        ...
        <p>
            ...
            Autumn winds<br>
            Blowing outside the window as I look around the room<br>
        ...
        <p>
            ...
            Tired of TV<br>
            I open the window and I gaze into the night<br>
    ...
    },
    {
        ...
        year: 2000,
        art: 'rascal-flatts-life-is-a-highway.jpg',
        lyrics: `
        <p>
            <i>Intro</i><br>
            Woo<br>
        ...
        <p>
            ...
            There's a world outside every darkened door<br>
        ...
        <p>
            ...
            Knock me down, I'm back up again<br>
        ...
        <p>
            <i>Refreng</i><br>
            Life is a highway<br>
            I wanna ride it all night long (Woo)<br>
            If you're goin' my way<br>
            I wanna drive it all night long (All night long)<br>
            A gimme, gimme, gimme, gimme, yeah<br>
            Life is a highway<br>
            I wanna ride it all night long (Hmm, yeah)<br>
            If you're goin' my way (You're goin' my way)<br>
            I wanna drive it all night long (All night long)
        </p>

        <p>
            <i>Bro</i><br>
            There was a distance between you and I (Between you and I)<br>
            A misunderstanding once<br>
            But now we look it in the eye<br>
            Ooh, yeah (Hmm, yeah)
        </p>
        ...
        <p>
            <i>Refrain</i><br>
            There ain't no load that I can't hold<br>
            The roads are rough, this I know<br>
            I'll be there when the light comes in<br>
        ...
        <p>
            <i>Refreng</i><br>
            Life is a highway<br>
            I wanna ride it all night long (All night long, yeah)<br>
            If you're goin' my way<br>
            I wanna drive it all night long (A gimme, gimme, gimme, a gimme, gimme, yeah)<br>
            Life is a highway (Life is a highway)<br>
            I wanna ride it all night long (Woo, yeah)<br>
            If you're goin' my way (Goin' my way)<br>
            I wanna drive it all night long (All night long, yeah;<br>
            come on, gimme, gimme, gimme, gimme, gimme, gimme, yeah)<br>
            Life is a highway
        </p>
        `,
    },
